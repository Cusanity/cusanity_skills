...
| **5. Chart Readability & Sub-Route Coverage** | **10 / 10** | Horizontal bold labels (`rotate: 0`); high-contrast text on colored bars (> 7:1 ratio); micro-segment collision suppression; elevated frosted tooltips; 100% route and sub-route coverage (water, electric, gas, total) across all viewports. |
